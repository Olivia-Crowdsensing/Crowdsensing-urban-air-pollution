...
def test_gf():
	import imageio
	cat = imageio.imread('201811262016113.jpg').astype(np.float32) / 255
	...
	imageio.imwrite('gf/cat_smoothed.png', cat_smoothed)
	imageio.imwrite('gf/cat_smoothed_s4.png', cat_smoothed_s4)
